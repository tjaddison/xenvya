          ...
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-br from-green-500 to-teal-600 rounded-xl p-6 text-white">
                ...
                <p className="mb-6">
                  Discover how our subscription-based solutions can transform your operations while providing predictable costs and continuous improvement.
                </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-bold mb-3">How does billing work for subscriptions?</h3>
              <p className="text-gray-600 dark:text-gray-300">
                We offer flexible billing options including monthly and annual plans, with discounts for annual commitments. Billing is automated through secure payment gateways, and detailed invoices are provided for all transactions.
              </p>
            </div>
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-bold mb-3">Can we customize the software to our needs?</h3>
              <p className="text-gray-600 dark:text-gray-300">
                Yes, our subscription solutions offer extensive configuration options to adapt to your workflows. For more specialized requirements, we offer custom development services that integrate seamlessly with our subscription platforms.
              </p>
            </div>
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-bold mb-3">What happens to our data if we discontinue service?</h3>
              <p className="text-gray-600 dark:text-gray-300">
                We provide comprehensive data export options to ensure you maintain ownership of your information. Upon service termination, we offer a grace period during which you can export all your data in standard formats before it's securely deleted from our systems.
              </p>
            </div>
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-bold mb-3">How often do you release updates?</h3>
              <p className="text-gray-600 dark:text-gray-300">
                Our subscription products follow a continuous delivery model with minor updates released biweekly and major feature rollouts quarterly. All updates are deployed with zero-downtime strategies to minimize disruption to your operations.
              </p>
            </div>
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-bold mb-3">What level of support is included?</h3>
              <p className="text-gray-600 dark:text-gray-300">
                All subscriptions include standard support with 24/7 emergency assistance and business-hours general support. Premium support packages are available featuring dedicated account managers, faster response times, and proactive monitoring.
              </p>
            </div>
          </div>
        </div>
